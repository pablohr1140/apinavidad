...
async function seedSectores(prisma) {
    const items = [
        { nombre: 'Norte' },
        { nombre: 'Centro' },
        { nombre: 'Sur' }
...
async function seedOrganizaciones(prisma, sectores) {
...
async function seedNinos(prisma, organizaciones, periodos, etnias) {
    const ninos = [
        {
            nombres: 'Mateo',
            apellidos: 'Rivas',
